...
json_ref = os.path.abspath(os.path.join(JSON, "arch_state_17/33/compression_network.json"))
json_in = os.path.abspath(os.path.join(JSON, "arch_state_17/33/compression_network_opt.json"))

csv_node_out = os.path.abspath(os.path.join(JSON, "arch_state_17/33/nodes.csv"))
csv_edge_out = os.path.abspath(os.path.join(JSON, "arch_state_17/33/edges.csv"))
